...
:clisp_autotools
rem ./configure sets a variable clisp which might be used instead of lisp.exe,
rem but when Maxima is crosscompiled on Linux, a shell script is used as 'crosscompiler',
rem which would be inserted here ==> do not use the variable clisp but just lisp.exe.
...
rem ./configure sets a variable sbcl which might be used instead of sbcl.exe,
rem but when Maxima is crosscompiled on Linux, a shell script is used as 'crosscompiler',
rem which would be inserted here ==> do not use the variable sbcl but just sbcl.exe.
